########################################################################################################################################
# Title: Above-ground biomass calculations for Updated generalized biomass equations for North American tree species 
...
AG_Biomass = function(FIA_species_code,dbh){
  ...
  else if(FIA_species_code %in% c(351,350)){ #Betulaceae , 0.40 spg
    b0 = -2.5932	
    b1 = 2.5349
    
  }
  else if(FIA_species_code %in% c(375,379)){ #Betulaceae 0.40 - 0.49 spg
    b0 = -2.2271	
    b1 = 2.4513
    
  }
  else if(FIA_species_code %in% c(371)){ #Betulaceae 0.50 - 0.59 spg
    b0 = -1.8096	
    b1 = 2.348
    
  }
  else if(FIA_species_code %in% c(372,701)){ #Betulaceae >= 0.60 spg
    b0 = -2.2652	
    b1 = 2.5349
  ...
  else if(FIA_species_code %in% c(407,407)){ #Carya
    b0 = -2.5095	
    b1 = 2.6175
  ...
  else if(FIA_species_code %in% c(807,814,843,850)){ #Fagaceae
    b0 = -3.0304	
    b1 = 2.4982
  ...
  else if(FIA_species_code %in% c(001)){ #composite of all hardwoods
    b0 = -22.2702
    b1 = 2.45436
  }
  ...
  else if(FIA_species_code %in% c(003,"NA")){ #composite of all species
    b0 = -2.23982
    b1 = 2.4529
  }
  
  biomass = (exp(1)^b0)*(dbh^b1) #ln(biomass) = b0 + b1 ln(diameter) or biomass = e^b0 * dbh^b1
  return(biomass)
}
